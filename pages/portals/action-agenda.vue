        ...
        <div class="col-lg-5 p-lg-0 z-10 img-size">
          ...
          <div class="caption">
            <a href="https://www.cbd.int/article/launch-Nature-Commitments-Platform-25May2022">
              <h4 class="text-box-1">
                {{$t('New Online Platform Showcases Civil Society, Local authority, and BusinessPledges for Nature')}}
              </h4>
            </a>
            <a href="https://naturecommitments.org/">
              <h6 class="text-box-2">{{$t('UNEP-WCMC\'s New Nature Commitments Platform | naturecommitments.org')}}</h6>
            </a>
          </div>
        </div>
      </div>
